...
for name in sampledirnames:
    ...
    file.write("java -jar /tools/cluster/6.2/picard-tools/1.87/BuildBamIndex.jar INPUT=" + root_path + name + "/" + name + ".rg.rmdup.sorted.bam \\\n")
    file.write("OUTPUT=" + root_path + name + "/" + name + ".rg.rmdup.sorted.bam.bai")
    file.close()
